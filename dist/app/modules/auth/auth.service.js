...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const newAccessToken = yield (0, userTokens_1.creteNewAccessTokenWithRefreshToken)(refreshToken);
    // const userTokens = createUserTokens(isUserExist);
    return {
...
const setPassword = (userId, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.password &&
        ...
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "You have already set your password. Now you can change the password from your profile update.");
    }
